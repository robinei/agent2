...
| Object destructuring rest of null/undefined gives `{}` (JS throws); of other primitives TypeError (JS gives `{}`) — inherits `ObjExtend` | ✅ Covered | `object_rest_null_source_divergence` | `compiler/tests/objects_arrays.rs` |
